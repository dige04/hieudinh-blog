        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-80 p-6">
            ...
            <nav className="space-y-2">
              ...
              <a href="/about" className="block px-4 py-2 rounded-lg hover:bg-accent text-sm font-medium">Giới thiệu</a>
              <a href="/contact" className="block px-4 py-2 rounded-lg hover:bg-accent text-sm font-medium">Liên hệ</a>
            </nav>
          </SheetContent>
        </Sheet>
      </header>
